...
import (
	...
	"github.com/lucasHSantiago/greenlight/internal/jsonlog"
	"github.com/lucasHSantiago/greenlight/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&cfg.env, "env", "development", "Environment (developtment|staging|production)")

	//postgres://greenlight:*****@localhost/greenlight?sslmode=disable
